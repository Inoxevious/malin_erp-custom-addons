...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url',
                                                    default='http://malinafrocouture.com//user/12.0/en/index.html')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url',
                                                        default='http://malinafrocouture.com//12.0/index.html')
        app_support_url = ir_config.get_param('app_support_url', default='http://malinafrocouture.com/.cn/trial/')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='http://malinafrocouture.com/.cn/my-account/')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='http://malinafrocouture.com/.cn')
        app_ribbon_name = ir_config.get_param('app_ribbon_name', default='')
        res.update(
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "http://malinafrocouture.com//documentation/user/12.0/en/index.html")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "http://malinafrocouture.com//documentation/12.0/index.html")
        ir_config.set_param("app_support_url", self.app_support_url or "http://malinafrocouture.com//trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "http://malinafrocouture.com//my-account/")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "http://malinafrocouture.com/")
        ir_config.set_param("app_ribbon_name", self.app_ribbon_name or " ")
